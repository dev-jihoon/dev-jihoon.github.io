...
function addSubject(tableElement) {
    const trElement = document.createElement("tr");
    ...
    new Selector(selectElement, "과목", subjects.normal.concat(subjects.art), (value) => {
...
document.querySelector("#calculate").addEventListener("click", () => {
    ...
    var absences = [...document.querySelectorAll("input[name='absenceInput']")].map((v) => parseInt(v.value));
    var tardinesss = [...document.querySelectorAll("input[name='tardinessInput']")].map((v) => parseInt(v.value));
    var leaves = [...document.querySelectorAll("input[name='leaveInput']")].map((v) => parseInt(v.value));
    ...
    var volunteerScore = volunteerScores[document.querySelector("#volunteerInput").value - 1] || 20;
